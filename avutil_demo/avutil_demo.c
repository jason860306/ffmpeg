...
int encoder(const char *p_in_fname, const char *p_out_fname){
	if (NULL == p_in_fname || NULL == p_out_fname)
	{
		return -1;
	}
	...
	FILE *in_file = fopen(p_in_fname, "rb");	//Input YUV data
	int in_w = 480, in_h = 272;                          //Input width and height
	//Frames to encode
	int framenum = 100;
	const char* out_file = p_out_fname;	            //Output Filepath
...
AVOption def_val;
//def_val.name = "test_int";
//def_val.help = "This is a test option of int type.";
//def_val.offset = offsetof(test_struct, int_opt);
//def_val.type = AV_OPT_TYPE_INT;
//def_val.default_val.i64 = -1;
//def_val.min = INT_MIN;
//def_val.max = INT_MAX;
...
static struct AVClass test_class; /*= {
								  .class_name = "test class",
								  .item_name = av_default_item_name,
								  .option = test_options,
								  .version = LIBAVUTIL_VERSION_INT,
								  };*/
test_class.class_name = "test class";
test_class.item_name = av_default_item_name;
test_class.option = test_options;
test_class.version = LIBAVUTIL_VERSION_INT;
#endif
