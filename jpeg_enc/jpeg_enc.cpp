 ...
 * @file	jpeg_enc.h
 *
 * @brief	最简单的基于FFmpeg的图像编码器
 * @details	本程序实现了YUV420P像素数据编码为JPEG图片。是最简单的FFmpeg编码方面的教程。
 *			通过学习本例子可以了解FFmpeg的编码流程。
 *
 * @version 1.0
 * @date	2016-03-25 10:53:14
 *
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	const char* out_file = "yuvgradientbar_1280x720_yuv420p.jpg";    //Output file  

	in_file = fopen("yuvgradientbar_1280x720_yuv420p.yuv", "rb");
