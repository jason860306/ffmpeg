...
int gen_rgb24_colorbar(int width, int height){
	...
	int i = 0, j = 0;
	int lum;
	float r_coeff = 0.299f, g_coeff = 0.587f, b_coeff = 0.114f;
	...
	lum = static_cast<int>(r_coeff*255.0 + g_coeff*255.0 + b_coeff*255.0);
	printf("[White]  \tR,G,B=255,255,255\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*255.0 + g_coeff*255.0 + b_coeff*0.0);
	printf("[Yellow] \tR,G,B=255,255,  0\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*0.0 + g_coeff*255.0 + b_coeff*255.0);
	printf("[Cyan]   \tR,G,B=  0,255,255\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*0.0 + g_coeff*255.0 + b_coeff*0.0);
	printf("[Green]  \tR,G,B=  0,255,  0\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*255.0 + g_coeff*0.0 + b_coeff*255.0);
	printf("[Magenta]\tR,G,B=255,  0,255\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*255.0 + g_coeff*0.0 + b_coeff*0.0);
	printf("[Red]    \tR,G,B=255,  0,  0\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*0.0 + g_coeff*0.0 + b_coeff*255.0);
	printf("[Blue]   \tR,G,B=  0,  0,255\t Y=%.3f*R+%.3f*G+%.3f*B=%3d\n",
		r_coeff, g_coeff, b_coeff, lum);
	lum = static_cast<int>(r_coeff*0.0 + g_coeff*0.0 + b_coeff*0.0);
